...
有链式代理和多个节点提供商之间负载均衡的需求，使用`grouptype=2`两个参数：

```
https://cdn.jsdelivr.net/gh/powerfullz/override-rules/convert.min.js#grouptype=2
```
...
```text
config_gt-{0|1|2}_ipv6-{0|1}_full-{0|1}_keepalive-{0|1}_fakeip-{0|1}_quic-{0|1}_tun-{0|1}_litecombine-{0|1}.yaml
```
