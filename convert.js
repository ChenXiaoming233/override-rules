...
(() => {
  ...
  // src/constants.ts
  var NODE_SUFFIX, LOW_COST_SUFFIX, CDN_URL, PROXY_GROUPS, LOW_COST_NODE_MATCHER, LANDING_NODE_MATCHER, countriesMeta;
  ...
  function buildCountryProxyGroups({
    ...
    const nodesByCountry = !regexFilter || splitLowCost ? Object.fromEntries(
